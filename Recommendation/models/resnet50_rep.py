...
class ResNet50(nn.Module):
    def __init__(self, block, image_channels, num_classes, include_top = True, weights='imagenet', need_rep=False):
    ...
    def forward(self, x):
        ...
        if self.need_rep:
            return x, repr1, repr2, repr3, repr4, rep
        else:
            return x
...
# model = ResNet50(ResNetBlock50, 3, 1000, include_top = True, need_rep=True)
