...
# load data
data = pd.read_csv('Classification\DatasetPrep\\fashion-dataset\styles_cleaned_bottom.csv')
...
for epoch in range(epochs):
    ...
    save_model(epochs, model, optimizer, criteria, name = 'model_resnet_bottom_' + str(curr_save) + '.pth')
    curr_save += 1
