...
class MultiHeadResNet_Tops(nn.Module):
    def __init__(self, pre_trained, requires_grad):
        super(MultiHeadResNet_Tops, self).__init__()
        if pre_trained == True:
        ...
        # for 13 articles
        self.l0 = nn.Linear(2048, 13)
        # for 38 colours
        self.l1 = nn.Linear(2048, 38)
        # for 3 genders
        self.l2 = nn.Linear(2048, 3)
        # for 7 usage
        self.l3 = nn.Linear(2048, 7)
