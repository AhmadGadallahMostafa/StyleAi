...
from models.resnet_mod_product_shoes import MultiHeadResNet
...
# load data
data = pd.read_csv('Classification\DatasetPrep\\fashion-dataset\styles_cleaned_shoes.csv')
...
for epoch in range(epochs):
    ...
    save_model(epochs, model, optimizer, criteria, name = 'model_resnet_shoes_' + str(curr_save) + '.pth')
    curr_save += 1
